...
printf {y in Ys, x in Xs}: "%15g %15g %15g \n", x, y, A_fin[x,y] > "./nccs_survey_test/solutions/ApodSol_APLC_quart_hex1X025c1_N0250_FPM400M050_LSann30D85X025c1Pad05_Img100C_35WA100CA100_BW10Nlam03fpres2_linbarpre1.dat";
