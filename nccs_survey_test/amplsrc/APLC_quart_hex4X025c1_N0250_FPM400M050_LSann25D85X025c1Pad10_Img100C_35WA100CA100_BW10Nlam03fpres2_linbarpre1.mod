...
read {y in Ys, x in Xs} TelAp[x,y] < "../InputMasks/TelAp/TelAp_quart_hex4X025c1_N0250.dat";
close "../InputMasks/TelAp/TelAp_quart_hex4X025c1_N0250.dat";
...
read {y in Ys,x in Xs} LS[x,y] < "../InputMasks/LS/LS_quart_ann25D85_X025c1Pad10_N0250.dat";
close "../InputMasks/LS/LS_quart_ann25D85_X025c1Pad10_N0250.dat";
...
printf {y in Ys, x in Xs}: "%15g %15g %15g \n", x, y, A_fin[x,y] > "./nccs_survey_test/solutions/ApodSol_APLC_quart_hex4X025c1_N0250_FPM400M050_LSann25D85X025c1Pad10_Img100C_35WA100CA100_BW10Nlam03fpres2_linbarpre1.dat";
